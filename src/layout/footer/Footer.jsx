...
const Footer = () => {
    return (
        <StFooter role="contentinfo">
            ...
            <StFooterAddressInfo>
                NEWNIQUE / Team3 NEWNEEK Clone Coding / BE: 권능현 김민규 김예진 김정빈 최서림 / FE: 김혜경 손규리 이도영
                <br />
                <a href="https://github.com/Team3-NEWNEEK-Clone-Coding">https://github.com/Team3-NEWNEEK-Clone-Coding</a>
                <br />
            </StFooterAddressInfo>
